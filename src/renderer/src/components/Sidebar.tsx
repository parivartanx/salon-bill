...
import { LayoutDashboard, Receipt, PlusSquare, List, FileText } from 'lucide-react'
      ...
      <nav className="p-4">
        {menuItems.map((item) => (
          <button
            ...
            className={`flex items-center w-full p-3 mb-2 rounded-lg transition-colors duration-200 ${activePage === item.page
